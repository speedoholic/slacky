...
class DataTableViewController: UITableViewController {
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        let fetchRequest =
            NSFetchRequest<NSManagedObject>(entityName: "WiFi")
        
        do {
            wifi = try managedContext.fetch(fetchRequest)
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.leftLabel?.text = wifi[indexPath.row].value(forKeyPath: "ssid") as? String
        cell.rightLabel?.text = wifi[indexPath.row].value(forKeyPath: "status") as? String
        return cell
    }
    ...
    override func tableView(_ tableView: UITableView, commit editingStyle: UITableViewCell.EditingStyle, forRowAt indexPath: IndexPath) {
        if editingStyle == .delete {
            delete(wifi[indexPath.row])
            wifi.remove(at: indexPath.row)
